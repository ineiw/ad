...
따라서 ```php base_convert($id,36,10)+{pw}-23230976 = 0 ```이되어야하므로 계산식은 base_convert((base_convert($id,36,10)-23230976),10,36) 이런식으로 나오게됩니다.이때 id는 관리자의 실수로인해 debug 가되고 
base_convert((base_convert('debug',36,10)-23230976),10,36) 이런식이됩니다.
